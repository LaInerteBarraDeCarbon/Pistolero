...
public abstract class Personaje {
	...
	/**
	 * Crea un personaje con su posici�n y su arma. <br>
	 * 
	 * @param posicion
	 * @param arma
	 */
	...
	/**
	 * Crea un personaje con su posici�n pero sin arma. <br>
	 * 
	 * @param posicion
	 */
	 ...
	 * 
	 * @param arma
	 * @return true si asign� el arma, false si ya ten�a una.
	 */
	...
	public void disparar(Personaje personaje) {
		...
		if (Math.abs(this.posicion - personaje.posicion) <= getDistanciaArma()) {
			...
			if (this.arma.unTiroMenos().equals(true)) {
				System.out.println("El arma se destruy�");
				this.tieneArma = false;
			}
		}
	}
